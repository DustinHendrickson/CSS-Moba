...
new Float:HealingWaveDistance[]={0.0,600.0,600.0,600.0,600.0};
new ParticleEffect[MAXPLAYERSCUSTOM][MAXPLAYERSCUSTOM]; // ParticleEffect[Source][Destination]

//skill 2
new Float:HexChanceArr[]={0.00,0.025,0.35,0.045,0.60};

//skill 3
new MaximumWards[]={0,2,3,4,4};
...
new Float:UltimateDuration[]={0.0,2.0,2.5,3.0,3.5}; ///big bad voodoo duration
