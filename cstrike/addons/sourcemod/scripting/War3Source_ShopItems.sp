...
public OnWar3LoadRaceOrItemOrdered(num)
{
	...
	iShopitem[ITEM_BOOTS] = War3_CreateShopItemT("boot", 3, false);
        iShopitem[ITEM_CLAW] = War3_CreateShopItemT("claw", 3, false);
        iShopitem[ITEM_CLOAK] = War3_CreateShopItemT("cloak", 2, false);
        iShopitem[ITEM_MASK] = War3_CreateShopItemT("mask", 3, false);
	iShopitem[ITEM_HEALTH] = War3_CreateShopItemT("health", 3, false);
	War3_AddItemBuff(iShopitem[ITEM_HEALTH], iAdditionalMaxHealth, 50);
	iShopitem[ITEM_ANTIWARD] = War3_CreateShopItemT("antiward", 3, false);

        if(GAMECSANY)
        {
            iShopitem[ITEM_ANKH] = War3_CreateShopItemT("ankh", 3, false);
            iShopitem[ITEM_GLOVES] = War3_CreateShopItemT("glove", 5, false);
            iShopitem[ITEM_MOLE] = War3_CreateShopItemT("mole", 10, false);
        }

        iShopitem[ITEM_FROST] = War3_CreateShopItemT("orb", 3, false);
        iShopitem[ITEM_RING] = War3_CreateShopItemT("ring", 3, false);

	iShopitem[ITEM_SOCK] = War3_CreateShopItemT("sock", 2, false);
	...
	iShopitem[ITEM_TOME] = War3_CreateShopItemT("tome", 10);
        ...
        iShopitem[ITEM_NECKLACE] = War3_CreateShopItemT("lace", 2, false);
